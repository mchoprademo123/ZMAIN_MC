CLASS zmc_travel_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZMC_TRAVEL_DATA IMPLEMENTATION.


METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_i056086.
...
*   fill internal travel table (itab)
    ...
    DATA itab1 TYPE TABLE OF zapfg_t001w.

*   fill internal travel table (itab)
    itab1 = VALUE #(
      ( client = '100' plant = '1024' description = 'N Global'   )
      ( client = '100' plant = '1025' description = 'N China'   )
      ( client = '100' plant = '1027' description = 'N India'   )
      ).
*insert the new table entries
    INSERT zapfg_t001w FROM TABLE @itab1.

*   delete existing entries in the database table
    DELETE FROM ztravel_i056086.

*   insert the new table entries
    INSERT ztravel_i056086 FROM TABLE @itab.
